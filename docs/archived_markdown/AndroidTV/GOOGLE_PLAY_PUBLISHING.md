...
FEATURES:
Γ£ô Remote content management
Γ£ô Support for images and videos
Γ£ô Automatic content refresh
Γ£ô Kiosk mode for unattended operation
Γ£ô Real-time device monitoring
Γ£ô QR code activation
Γ£ô Centralized dashboard control

PERFECT FOR:
ΓÇó Retail stores and restaurants
ΓÇó Corporate offices and lobbies
ΓÇó Educational institutions
ΓÇó Healthcare facilities
ΓÇó Hotels and hospitality

REQUIREMENTS:
ΓÇó Android TV device (Android 5.0+)
ΓÇó Network connection
ΓÇó Digital Signage server (contact support)
...
1. Go to "Release" ΓåÆ "Production"
